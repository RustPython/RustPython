...
assert_raises(TypeError, no_args, 'one_arg')  # 1 arg to no_args
assert_raises(TypeError, no_args, kw='should fail')  # kwarg to no_args
...
assert_raises(TypeError, one_arg)  # no args to one_arg

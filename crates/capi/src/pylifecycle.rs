...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn Py_IsInitialized() -> c_int {
    INTERP.with(|interp| interp.borrow().is_some() as c_int)
}

#[unsafe(no_mangle)]
pub extern "C-unwind" fn Py_Initialize() {
    Py_InitializeEx(0);
}

#[unsafe(no_mangle)]
pub extern "C-unwind" fn Py_InitializeEx(_initsigs: c_int) {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn Py_Finalize() {
    let _ = Py_FinalizeEx();
}

#[unsafe(no_mangle)]
pub extern "C-unwind" fn Py_FinalizeEx() -> c_int {
    INTERP.with(|interp_ref| {
        let interp = ManuallyDrop::into_inner(interp_ref.borrow_mut().take()
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn Py_IsFinalizing() -> c_int {
    0
}

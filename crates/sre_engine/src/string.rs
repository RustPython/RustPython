...
pub(crate) fn is_space(ch: u32) -> bool {
    unicode::regex::is_space(ch)
}
#[inline]
pub(crate) fn is_digit(ch: u32) -> bool {
    unicode::regex::is_digit(ch)
}
#[inline]
pub(crate) fn is_loc_alnum(ch: u32) -> bool {
    unicode::regex::is_loc_alnum(ch)
}
#[inline]
...
pub fn lower_unicode(ch: u32) -> u32 {
    unicode::regex::lower_unicode(ch)
}
#[inline]
#[must_use]
pub fn upper_unicode(ch: u32) -> u32 {
    unicode::regex::upper_unicode(ch)
}

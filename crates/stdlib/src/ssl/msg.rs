...
pub(super) const SSL3_RT_CHANGE_CIPHER_SPEC: i32 = 20;
pub(super) const SSL3_RT_ALERT: i32 = 21;
pub(super) const SSL3_RT_HANDSHAKE: i32 = 22;
pub(super) const SSL3_RT_APPLICATION_DATA: u8 = 23;
pub(super) const SSL3_RT_HEADER: i32 = 256;
pub(super) const SSL3_MT_CHANGE_CIPHER_SPEC: i32 = 0x0101;
const TLS_RECORD_HEADER_SIZE: usize = 5;

#[derive(Debug, Default)]
pub(super) struct MsgState {
...
impl MsgState {
    pub(super) fn transcript(&self) -> &[u8] {
        &self.transcript
    }

    pub(super) fn observe(&mut self, write: bool, bytes: &[u8]) -> Vec<MsgEvent> {
...
mod tests {
    ...
    fn splits_complete_records_and_handshake_messages() {
        ...
        assert_eq!(state.transcript, vec![12, 0, 0, 4, 1, 2, 3, 4]);
    }

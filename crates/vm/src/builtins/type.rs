...
impl PyType {
    ...
    fn set___annotations__(
        ...
        // Drop old values OUTSIDE the type lock to avoid deadlock:
...
impl SetAttr for PyType {
    fn setattro(
        ...
        // dropping may trigger weakref callbacks, which may call methods,
        // which may trigger LOAD_ATTR specialization (version_for_specialization),
        // which also acquires the type lock.
        let _prev_value = Self::with_type_lock(vm, || {

...
class BasicTest(BaseTest):
    ...
    # TODO: RUSTPYTHON ñ venv executable creation not fully functional
    @unittest.expectedFailureIfWindows("TODO: RUSTPYTHON ñ venv executable creation not fully functional")
    ...
    # TODO: RUSTPYTHON
    @unittest.expectedFailureIfWindows("TODO: RUSTPYTHON")
    # TODO: RUSTPYTHON ñ venv upgrade not yet implemented
    @unittest.expectedFailureIfWindows("TODO: RUSTPYTHON ñ venv upgrade not yet implemented")
    ...
    def test_unicode_in_batch_file(self):
        ...
        """
        rmtree(self.env_dir)
        env_dir = os.path.join(os.path.realpath(self.env_dir), 'œº—û–¢Œª–§–ô')
        builder = venv.EnvBuilder(clear=True)
        builder.create(env_dir)
        activate = os.path.join(env_dir, self.bindir, 'activate.bat')
    ...
    # TODO: RUSTPYTHON
    @unittest.expectedFailureIfWindows("TODO: RUSTPYTHON")
    # TODO: RUSTPYTHON ñ zip path detection broken in RustPython
    @unittest.expectedFailureIfWindows("TODO: RUSTPYTHON ñ zip path detection broken in RustPython")

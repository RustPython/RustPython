...
class CodeopTests(unittest.TestCase):
    ...
    @unittest.expectedFailure  # TODO: RUSTPYTHON; AssertionError: <code object <module> at 0x55f3265274b0 file "<input>", line 1> != <code object <module> at 0x55f326572440 file "<input>", line 1>
    def test_valid(self):
        av = self.assertValid
    ...
    @unittest.expectedFailure  # TODO: RUSTPYTHON; AssertionError: <code object <module> at 0x55f3264df8c0 file "<input>", line 1> != None

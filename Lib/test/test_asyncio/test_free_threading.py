...
class TestPyFreeThreading(TestFreeThreading, TestCase):
    ...
    @unittest.expectedFailure  # TODO: RUSTPYTHON; AssertionError: <Task finished name='Task-7322' coro=<TestFreeThreading.test_task_different_thread_finalized.<locals>.func() done, defined at crates/pylib/Lib/test/test_asyncio/test_free_threading.py:101> result=None> is not None
...
class TestEagerPyFreeThreading(TestPyFreeThreading):
    ...
    @unittest.expectedFailure  # TODO: RUSTPYTHON; AssertionError: <Task finished name='Task-5240' coro=<TestFreeThreading.test_task_different_thread_finalized.<locals>.func() done, defined at crates/pylib/Lib/test/test_asyncio/test_free_threading.py:101> result=None> is not None
    def test_task_different_thread_finalized(self):
        return super().test_task_different_thread_finalized()

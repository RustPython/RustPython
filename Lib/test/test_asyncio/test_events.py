...
class EventLoopTestsMixin:
    ...
    # TODO: RUSTPYTHON - RuntimeWarning for unawaited coroutine not triggered
    ...
    # TODO: RUSTPYTHON - signal handler implementation differs
    @unittest.expectedFailure
    ...
    # TODO: RUSTPYTHON - SSL peer certificate format differs
    @unittest.expectedFailure
    @unittest.skipIf(ssl is None, 'No ssl module')
...
class PolicyTests(unittest.TestCase):
    ...
    # TODO: RUSTPYTHON - mock.patch doesn't work correctly with threading.current_thread
    @unittest.expectedFailure

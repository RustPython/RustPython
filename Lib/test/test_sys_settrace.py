...
""", "<fake module>", "exec")
    ...
    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_backwards_into_try_except_block(self):
        return super().test_no_jump_backwards_into_try_except_block()

    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_backwards_into_try_finally_block(self):
        return super().test_no_jump_backwards_into_try_finally_block()

    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_between_except_blocks_2(self):
        return super().test_no_jump_between_except_blocks_2()

    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_forwards_into_try_except_block(self):
        return super().test_no_jump_forwards_into_try_except_block()

    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_forwards_into_try_finally_block(self):
        return super().test_no_jump_forwards_into_try_finally_block()

    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_out_of_bare_except_block(self):
        return super().test_no_jump_out_of_bare_except_block()

    @unittest.expectedFailure  # TODO: RUSTPYTHON
    def test_no_jump_out_of_qualified_except_block(self):
        return super().test_no_jump_out_of_qualified_except_block()

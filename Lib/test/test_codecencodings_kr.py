...
@unittest.skip("TODO: RUSTPYTHON; unknown encoding: cp949")
...
@unittest.skip("TODO: RUSTPYTHON; unknown encoding: euc_kr")
...
@unittest.skip("TODO: RUSTPYTHON; unknown encoding: johab")

...
macro_rules! construct_keywords {
    ($($kw:expr, $typ:expr),*) => {
        {
            let mut kwreturn: HashMap<String, Tok> = HashMap::new();

            $(
                kwreturn.insert(String::from($kw), $typ);
            )*
...
pub fn get_keywords() -> HashMap<String, Tok> {
    let keywords: HashMap<String, Tok> = construct_keywords![
        "...", Tok::Ellipsis,
        "False", Tok::False,
        "None", Tok::None,
        "True", Tok::True,
